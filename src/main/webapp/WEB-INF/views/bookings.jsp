...
<main id="main">
    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <a href="/bookingInfo/${book.getId()}">
          <div class="col-lg-6 col-md-9 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap" >
              <figure class="extra">
                <img src="data:image/jpeg;base64,${products.findByid(book.getProductid()).getBase64()}" class="img-fluid" alt="">
                </figure>

              <div class="portfolio-info" style="height:110px">
                <h4><a href="#">${products.findByid(book.getProductid()).getName()}</a></h4>
                <p>£${book.getCost()}</p>
